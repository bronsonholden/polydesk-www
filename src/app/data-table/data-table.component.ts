...
export class DataTableComponent implements OnInit {
  ...
  getDisplayedColumns() {
    return this.tableConfig.display;
  }

  getColumnInfo(name) {
    return this.tableConfig.columns[name];
  }
